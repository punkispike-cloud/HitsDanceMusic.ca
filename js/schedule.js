...
export const SLOT_TAGS = {
  morning:   { color: "#e6b85c", label: "Réveil" },
  hitlist:   { color: "#cf9b3f", label: "Rotation Rock" },
  drive:     { color: "#e07a3a", label: "Drive" },
  limelight: { color: "#b5651d", label: "Légendes" },
  night:     { color: "#8a1f1a", label: "Nuit Métal" },
  special:   { color: "#c0532b", label: "Spécial" },
  audition:  { color: "#8a8170", label: "Découverte" },
};
...
export function getCurrentSlot(date = new Date()) {
  ...
  return { from: "00:00", to: "07:00", title: "Rockfort en continu", host: "Programmation", tag: "hitlist", day };
}
